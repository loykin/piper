...
import {
  listNotebookVolumes, purgeNotebookVolume, listNotebookWorkers,
...
export default function NotebookVolumesPage() {
  ...
  // workerIdMap resolves UUID worker_id (legacy) → hostname.
  // New volumes already store hostname directly; this map handles old data.
