...
type Registration struct {
	...
	Mode          string                 `protobuf:"bytes,8,opt,name=mode,proto3" json:"mode,omitempty"` // "process" | "docker" for notebook bare-metal workers
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Registration) GetMode() string {
	if x != nil {
		return x.Mode
	}
	return ""
...
const file_agent_proto_rawDesc = "" +
	...
	"\x06labels\x18\a \x03(\v2(.piper.agent.v1.Registration.LabelsEntryR\x06labels\x12\x12\n" +
	"\x04mode\x18\b \x01(\tR\x04mode\x1a9\n" +
