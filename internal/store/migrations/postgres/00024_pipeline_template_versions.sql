...
INSERT INTO pipeline_templates (project_id, id, name, created_at, updated_at)
...
ALTER TABLE schedules ADD COLUMN IF NOT EXISTS template_version_id TEXT NOT NULL DEFAULT '';
...
INSERT INTO pipelines_restored (project_id, id, name, yaml, snapshot_id, volume_id, created_at)
