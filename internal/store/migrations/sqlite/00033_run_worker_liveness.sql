...
ALTER TABLE runs ADD COLUMN worker_last_seen_at TIMESTAMP;
...
ALTER TABLE runs ADD COLUMN cancel_requested_at TIMESTAMP;
...
ALTER TABLE runs DROP COLUMN worker_last_seen_at;
