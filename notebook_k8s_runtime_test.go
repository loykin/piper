...
`
	...
	if nb.WorkerID != notebookK8sLocalWorkerID {
		t.Fatalf("WorkerID = %q, want %q (direct-runtime local identity, not a remote worker)", nb.WorkerID, notebookK8sLocalWorkerID)
	}
