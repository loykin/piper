...
func NewAgentDriver(router *iagent.Router, rpc AgentRPC, repo ...Repository) *AgentDriver {
...
func (d *AgentDriver) ProvisionVolume(ctx context.Context, vol *NotebookVolume, storageSize string) error {
...
func (d *AgentDriver) Start(ctx context.Context, spec NotebookServerSpec, vol *NotebookVolume, yamlStr string) (*NotebookServer, error) {
...
func (d *AgentDriver) Stop(ctx context.Context, nb *NotebookServer) error {
...
func (d *AgentDriver) DeprovisionVolume(ctx context.Context, vol *NotebookVolume) error {
	agentInfo, err := d.selectAgent(vol.WorkerID)
	if err != nil {
		return nil
	}
...
func (d *AgentDriver) provisionBareMetalVolume(ctx context.Context, agentInfo *iagent.Info, vol *NotebookVolume) error {
	var result struct {
		WorkDir string `json:"work_dir"`
	}
...
func (d *AgentDriver) startBareMetal(ctx context.Context, agentInfo *iagent.Info, spec NotebookServerSpec, vol *NotebookVolume, yamlStr string) (*NotebookServer, error) {
	workDir := ""
	volumeID := ""
	if vol != nil {
		workDir = vol.WorkDir
...
func (d *AgentDriver) stopBareMetal(ctx context.Context, agentInfo *iagent.Info, nb *NotebookServer) error {
...
func (d *AgentDriver) deprovisionBareMetalVolume(ctx context.Context, agentInfo *iagent.Info, vol *NotebookVolume) error {
	if vol.WorkDir == "" {
		return nil
	}
...
func (d *AgentDriver) SyncStatus(ctx context.Context, servers []*NotebookServer) error {
	if d == nil || d.repo == nil {
		return nil
	}
