...
func (r *Driver) Start(_ context.Context, req notebookdriver.StartRequest) (*notebookdriver.StartedHandle, error) {
	var env, gpus string
	...
	return &notebookdriver.StartedHandle{Endpoint: endpoint, PID: pid, Token: req.Token, EnvPath: envPath}, nil
}
...
func (r *Driver) Recover(_ context.Context, onRecovered func(notebookdriver.RecoveredHandle) func(string), onTerminal func(notebookdriver.RecoveredHandle, string)) error {
