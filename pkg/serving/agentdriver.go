...
func NewAgentDriver(router *iagent.Router, rpc AgentRPC, repo Repository, masterURL ...string) *AgentDriver {
...
func (d *AgentDriver) Deploy(ctx context.Context, spec ModelService, art artifact.Resolved, yamlStr string) (*Service, error) {
...
func (d *AgentDriver) Stop(ctx context.Context, svc *Service) error {
...
func (d *AgentDriver) Restart(ctx context.Context, spec ModelService, art artifact.Resolved, yamlStr string) error {
...
func (d *AgentDriver) deployBareMetal(ctx context.Context, agentInfo *iagent.Info, spec ModelService, art artifact.Resolved, yamlStr string) (*Service, error) {
	var result struct {
		Endpoint string `json:"endpoint"`
	}
...
func (d *AgentDriver) stopBareMetal(ctx context.Context, agentInfo *iagent.Info, svc *Service) error {
...
func (d *AgentDriver) restartBareMetal(ctx context.Context, agentInfo *iagent.Info, spec ModelService) error {
...
func serviceWorkerID(svc *Service) string {
	if svc == nil {
		return ""
	}
	return svc.WorkerID
...
func artifactLabel(svc ModelService) string {
